pub const TEST_DATA_0: [([&'static str; 10], [&'static str; 4]); 1] = [
    (["acedgfb", "cdfbe", "gcdfa", "fbcad", "dab", "cefabd", "cdfgeb", "eafb", "cagedb", "ab"], ["cdfeb", "fcadb", "cdfeb", "cdbaf"])
];

pub const TEST_DATA_1: [([&'static str; 10], [&'static str; 4]); 10] = [
...
pub const TEST_DATA_2: [([&'static str; 10], [&'static str; 4]); 200] = [
